...
loc <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/02-12-18/"
dir.create(loc)
network.folder <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/02-12-18/cytoscape_networks/" 
dir.create(network.folder)

# constants

# files
mimp.added.modules <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/02-05-18/mimp_added_modules.rds")
mimp <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/read-only/mimp.results.rds")
clins <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/01-08-18/unsplit_fixed_clin.rds")
muts <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/01-08-18/unsplit_mutation_data.rds")
mimp.modules <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/02-05-18/mimp_modules.rds")

network <- fread("/.mounts/labs/reimandlab/private/users/thuang/data_2/read-only/network_interaction_data_hugo.tsv", header = F)
# file names
survival.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/02-12-18/scurves.pdf" 
mutation.matrix.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/02-12-18/mutation.matrix.pdf" 
modules.non.linker.added.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/02-12-18/modules_added_nonlinkers.rds" 
...
AddNonLinker <- function(mut.joined, mimp) {
	...
	aggregated <- mut.joined %>% 
						...
						summarize(List_of_patients = unique(paste(List_of_patients, collapse = ",")), gene = unique(paste(gene, collapse = ";")))
...
DrawSurvivalCurvesByCancerType <- function(nonlinkers.added, muts, clins, survival.file) {
	...
	# split clin by cancer
	split.clins <- split(clins, f = clins$Study_Name)
...
DrawSurvivalCurvesByCancerType(nonlinkers.added, muts, clins, survival.file) #  FIGURE OUT HOW MANY POSITIVE OR NEGATIVE
