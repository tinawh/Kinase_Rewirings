...
def write_hypermodules_script(mutation_dir, clinical_dir, file_location = "/.mounts/labs/reimandlab/private/users/thuang/bin_2/hypermodules_biogrid_10/", result_location = "/.mounts/labs/reimandlab/private/users/thuang/data_2/hypermodules_biogrid_10/"):
        ...
        for i in range(len(mut_files)):
                files += """java -jar /.mounts/labs/reimandlab/private/users/thuang/HyperModules_1.0.2_CMD/HyperModulesCMD-1.0.2.jar -n /.mounts/labs/reimandlab/private/users/thuang/data_2/02-19-18/biogrid_network.tsv -s {0}{1} -c {2}{3} -S 10 -t logrank -p 0.05 -C 32 > {4}hypermodules_100_{5}.txt
