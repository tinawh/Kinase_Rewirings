...
# files
nosubset.results <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/nosubset_hypermodules_results.rds")
mimp <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/read-only/mimp.results.rds") 

# file names
mimp.added.modules.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/mimp_added_modules.rds"
mimp.modules.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/mimp_modules.rds"
