...
#dir.create(loc)
network.folder <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/cytoscape_networks_permut_10/" 
dir.create(network.folder)

# constants

# files
mimp.added.modules <- readRDS("/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/mimp_added_modules_permut_10.rds")
...
# file names
survival.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/scurves_permut_10.pdf" 
mutation.matrix.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/mutation_matrix_permut_10.pdf" 
modules.non.linker.added.file <- "/.mounts/labs/reimandlab/private/users/thuang/data_2/03-05-18/modules_added_nonlinkers_permut_10.rds" 
